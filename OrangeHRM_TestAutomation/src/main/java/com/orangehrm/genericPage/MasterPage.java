...
public class MasterPage {
    ...
    public void loadProperties() throws Exception {
        ...
        FileInputStream propfip = new FileInputStream(
                System.getProperty("user.dir") + "\\src\\main\\java\\com\\orangehrm\\repository\\configuration.properties");
        config = new Properties();
        config.load(propfip);

        try {
            FileInputStream locfip = new FileInputStream(
                    System.getProperty("user.dir") + "\\src\\main\\java\\com\\orangehrm\\repository\\locators.properties");
            loc = new Properties();
            loc.load(locfip);
        ...
        FileInputStream tdfip = new FileInputStream(
                System.getProperty("user.dir") + "\\src\\main\\java\\com\\orangehrm\\repository\\testdata.properties");
        td = new Properties();
        td.load(tdfip);
    }
        ...
        if (driver == null) { // Only initialize if not already initialized
            if (config.getProperty("browser").equalsIgnoreCase("chrome")) {
                System.setProperty("webdriver.chrome.driver",
                        System.getProperty("user.dir") + "\\src\\main\\java\\com\\orangehrm\\drivers\\chromedriver.exe");
                driver = new ChromeDriver();
            } else if (config.getProperty("browser").equalsIgnoreCase("firefox")) {
                System.setProperty("webdriver.gecko.driver",
                        System.getProperty("user.dir") + "\\src\\main\\java\\com\\orangehrm\\drivers\\geckodriver.exe");
